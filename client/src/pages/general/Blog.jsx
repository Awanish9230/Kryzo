                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {posts.map((post, idx) => (
                            ...
                            >
                                <div className={`aspect-video rounded-3xl ${post.img}/10 mb-6 border border-white/5 overflow-hidden relative`}>
                                    <div className={`absolute inset-0 ${post.img}/20 blur-3xl`} />
                                    <div className="absolute inset-0 flex items-center justify-center">
                                        {/* Placeholder for image */}
                                        <span className="font-bold text-white/20 text-4xl">Kryzo</span>
                                    </div>
                                </div>
                                <div className="flex items-center gap-3 text-sm font-bold text-zinc-500 uppercase tracking-widest mb-3">
